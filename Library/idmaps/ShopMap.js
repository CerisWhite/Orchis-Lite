	...
	switch(TradeData['destination_entity_type']) {
		...
		case 7:
			...
			if (UserIndexRecord['dragon_list'].length <= 1000) {
				...
				NewEntityList.push({ 'entity_type': 7, 'entity_id': DragonData['id'] }); u++; }
			}
			break;
		case 8:
...
module.exports = { DrawShopItemSpecial, DrawShopItem, WyrmprintTrade, GetPrintTradeCost, GetTradePrintID, TreasureTrade, TradeTreasure }